  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
        ...
        <div className="w-[380px] rounded-xl border border-slate-200 bg-white shadow-xl">
          ...
          <div className="px-4 py-3">
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                <div
                  className={`flex items-center gap-2 rounded-[7px] px-3 py-2 ${
                    isAiActive ? "bg-white" : ""
                  }`}
                >
                  <input
                  ...
                  <button
                    ...
                    className={`relative flex h-7 w-7 shrink-0 items-center justify-center rounded-full border transition disabled:cursor-not-allowed disabled:opacity-40 ${
                      listening
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-lg bg-[#2979ff] px-3 py-1.5 text-[12px] font-medium text-white shadow-sm transition hover:bg-[#1e6fe6] disabled:cursor-not-allowed disabled:bg-slate-300"
                  >
                    {loading ? "実行中" : "送信"}
                  </button>
                </div>
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#2979ff] text-white shadow-lg transition hover:bg-[#1e6fe6] hover:shadow-xl active:scale-95"
        title="AI アシスタント"
      >
        {open ? (
